...
class PhonesControllerTest < ActionController::TestCase
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post :create, phone: { contact_detail_id: @phone.contact_detail_id, number: @phone.number, phone_type: @phone.phone_type }
    end
  ...
  test "should update phone" do
    patch :update, id: @phone, phone: { contact_detail_id: @phone.contact_detail_id, number: @phone.number, phone_type: @phone.phone_type }
    assert_redirected_to phone_path(assigns(:phone))
  end
