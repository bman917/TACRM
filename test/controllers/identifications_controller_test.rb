...
class IdentificationsControllerTest < ActionController::TestCase
  ...
  test "should create identification" do
    assert_difference('Identification.count') do
      post :create, identification: { foid: @identification.foid, notes: @identification.notes, profile_id: @identification.profile_id, foid_type: @identification.foid_type }
    end
  ...
  test "should update identification" do
    patch :update, id: @identification, identification: { foid: @identification.foid, notes: @identification.notes, profile_id: @identification.profile_id, foid_type: @identification.foid_type }
    assert_redirected_to identification_path(assigns(:identification))
  end
